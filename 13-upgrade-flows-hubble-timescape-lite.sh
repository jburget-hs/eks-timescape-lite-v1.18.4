...
helm install hubble-enterprise isovalent/hubble-enterprise --version 1.13.2 \
    --namespace kube-system 

sleep 30

#next update for flow export
helm upgrade hubble-enterprise isovalent/hubble-enterprise --version 1.13.2 \
...
#NEW VERSIONS - NOV 25
# - hubble-enterprise - change to version 13.2
# - old version = 1.13.0