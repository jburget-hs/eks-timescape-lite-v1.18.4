...
echo " "
echo "***********************************"
echo "ENABLING TETRAGON TRACING POLICIES"
echo " AND LISTING POLICIES CREATED"
echo " AND SETTING MODEL SHOW FOR THE TETRAGON DAEMONSET"
echo "***********************************"
source 14a-tracing-policies.sh

echo " "
echo "***********************************"
echo "UPGRADING HELM WITH FLOW EXPORT FOR TIMESCAPE"
echo " AND RESTARTING ALL DAEMONSETS"
echo "***********************************"
source 14b-export-for-hubble.sh
