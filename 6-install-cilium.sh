...
helm install cilium isovalent/cilium --version 1.18.4 --namespace kube-system -f cilium-enterprise-values.yaml --timeout 90s --debug || true

# --version old version used 1.17.7 - this worked
